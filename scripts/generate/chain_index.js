...
const defaultExport = `export default { ${files.filter((file) => file !== 'index.ts').map((file) => file.slice(0, -3)).join(', ')} };`;
const indexContent = [autogeneratedComment, ...importStatements, defaultExport].join('\n');
